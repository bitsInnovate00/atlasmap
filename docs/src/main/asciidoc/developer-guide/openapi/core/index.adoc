...
// markup not found, no include::{specDir}recommendations/POST/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}recommendations/POST/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}recommendations/POST/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :recommendations/POST/POST.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}recommendations/POST/implementation.adoc[opts=optional]
